...
multiples = [0, 3, 6, 9, 12, 15, 18, 21, 24, 27]
print(replace_third_and_last(multiples))
...
multiples = [0, 3, 6, 9, 12, 15, 18, 21, 24, 27]
print(replace_middle(multiples))
...
notes = ['Do', 'Re', 'Mi', 'Fa', 'So', 'La', 'Ti', 'Do'] 
print(delete_third_and_seventh(notes))   
