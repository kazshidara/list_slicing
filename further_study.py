...
def custom_extend(input_list, second_list):
    ...
    For example:
        ...
        >>> custom_extend(input_list, second_list = ['Apr', 'May'])
...
custom_extend(['Jan', 'Feb', 'Mar'], ['Apr', 'May'])
...
def custom_insert(input_list, index, value):
    ...
    # print([value, input_list[index:]],'[value, input_list[index:]]')
    # print(new_list)
...
custom_remove(['Do', 'Re', 'Mi', 'Fa', 'So', 'La', 'Ti', 'Do'], 'Do')
